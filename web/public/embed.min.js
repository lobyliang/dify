async function embedChatbot() {
  ...
  if (t && t.token) {
    ...
    if (!document.getElementById("dream-chatbot-bubble-button")) {
      e = document.createElement("div");
      (e.id = "dream-chatbot-bubble-button"),
        (e.style.cssText =
      ...
      (d.style.cssText =
        ...
        e.addEventListener("click", function () {
          var e = document.getElementById("dream-chatbot-bubble-window");
          e
            ...
            : (((e = document.createElement("iframe")).allow =
              ...
              (e.title = "dream chatbot bubble window"),
              (e.id = "dream-chatbot-bubble-window"),
