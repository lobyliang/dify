...
const ExtraInfo = ({ isMobile, relatedApps }: IExtraInfoProps) => {
  ...
  const [isShowTips, { toggle: toggleTips, set: setShowTips }] =
    useBoolean(!isMobile);
...
const DatasetDetailLayout: FC<IAppDetailLayoutProps> = (props) => {
  ...
  useEffect(() => {
    if (datasetRes) document.title = `${datasetRes.name || "Dataset"} - Dream`;
  }, [datasetRes]);
    ...
    <div className="grow flex overflow-hidden">
      {!hideSideBar && (
        <AppSideBar
          ...
          icon={
            datasetRes?.icon ||
            "https://static.dream.ai/images/dataset-default-icon.png"
          }
