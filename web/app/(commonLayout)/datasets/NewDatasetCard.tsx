...
const CreateAppCard = forwardRef<HTMLAnchorElement>((_, ref) => {
  ...
  return (
    <a
      ref={ref}
      className="group flex flex-col col-span-1 bg-gray-200 border-[0.5px] border-black/5 rounded-xl min-h-[160px] transition-all duration-200 ease-in-out cursor-pointer hover:bg-white hover:shadow-lg"
    ...
    >
      ...
      <div className="mb-1 px-4 text-xs leading-normal text-gray-500 line-clamp-4">
