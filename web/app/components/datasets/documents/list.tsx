...
export const StatusItem: FC<{
  ...
  return (
    ...
    >
      ...
      />
      <span className={cn("text-gray-700 text-sm", textCls)}>
...
const DocumentList: FC<IDocumentListProps> = ({
  ...
  return (
    <div className="w-full h-full overflow-x-auto">
      <table
        className={`min-w-[700px] max-w-full w-full border-collapse border-0 text-sm mt-3 ${s.documentTable}`}
      >
                  ...
                  <div className="group flex items-center justify-between">
                    <span className={s.tdValue}>
                      {doc?.data_source_type === DataSourceType.NOTION ? (
                        <NotionIcon
                          className="inline-flex -mt-[3px] mr-1.5 align-middle"
                          type="page"
