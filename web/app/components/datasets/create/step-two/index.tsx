...
const StepTwo = ({
  ...
  const [qaModel, setQaModel] = useState<string>(
    datasetId && documentDetail && documentDetail.doc_form === DocForm.ROWQA
      ? "normal"
      : "ai",
  );
  ...
  const handleSelectQaModel = (model: string) => {
    if (model !== "ai") setDocForm(DocForm.ROWQA);
    else setDocForm(DocForm.QA);
    setQaModel(model);
  };
                ...
                <div className="flex justify-between items-center px-5 py-4">
                  ...
                  <div className="grow mx-3">
                    ...
                    <div className="text-[13px] leading-[18px] text-gray-500">
                      {(docForm === DocForm.QA ||
                        docForm === DocForm.ROWQA) && (
                        <div className="flex items-center">
                          <span className="pr-1">分段模式</span>
                          <ModelSelect
                            currentLanguage={qaModel}
                            onSelect={handleSelectQaModel}
                          />
                        </div>
                      )}
                  ...
                  <div className="shrink-0">
                    <Switch
                      defaultValue={
                        docForm === DocForm.QA || docForm === DocForm.ROWQA
                      }
                ...
                <div className={s.label}>
                  ...
                  {/* <div className="leading-[18px] text-xs font-normal text-gray-500">
                    <a
                      ...
                      href="https://docs.dream.ai/features/retrieval-augment"
                      className="text-[#155eef]"
                    >
              ...
              <div className="flex items-center justify-between px-8">
                <div className="grow flex items-center">
                  ...
                  {(docForm === DocForm.QA || docForm === DocForm.ROWQA) &&
                    !previewSwitched && (
                      <Button
                        className="ml-2 !h-[26px] !py-[3px] !px-2 !text-xs !font-medium !text-primary-600"
