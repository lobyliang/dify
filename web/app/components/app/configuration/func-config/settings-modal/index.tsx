...
const SettingsModal: FC<SettingsModalProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Body */}
      <div
        className="p-6 pt-5 border-b overflow-y-auto pb-[68px]"
        style={{
      ...
      >
        ...
        <div className={cn(rowClass)}>
          ...
          <div className="w-full">
            ...
            />
            <a
              className="mt-2 flex items-center h-[18px] px-3 text-xs text-gray-500"
              href="https://docs.dream.ai/features/datasets#how-to-write-a-good-dataset-description"
              target="_blank"
      ...
      >
        <Button onClick={onCancel} className="mr-2 text-sm font-medium">
