...
const Configuration: FC = () => {
  ...
  const [setting, setSetting] = useState<FuncSetting>({
    category: "",
    cmd: "",
    func_name: "",
    match_list: [],
      ...
      fetchAppDetail({ url: "/apps", id: appId }).then(async (res: any) => {
        ...
        console.log(
          res.questions &&
            ...
            res.questions.map((item: any) => item.questions),
        );
        ...
        setSetting({
          ...
          match_list:
            (res.questions &&
              ...
              res.questions.map((item: any) => item.questions)) ||
            [],
          is_robot: res.is_robot,
          chat_icon: res.chat_icon || "",
        });
      ...
      <>
        <div className="flex flex-col h-full">
          <div className="relative flex grow h-[200px] pt-14">
            ...
            <div
              className={`w-full sm:w-1/2 shrink-0 flex flex-col h-full ${debugWithMultipleModel && "max-w-[560px]"}`}
            >
              <Config />
            </div>
            {!isMobile && (
