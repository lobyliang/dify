    ...
    <>
      ...
      >
        ...
        <div className="flex mt-2">
          ...
          />
          <input
            className={`flex-grow rounded-lg h-10 box-border px-3 ${s.projectName} bg-gray-100`}
        ...
        />
        <div
          className={`mt-6 mb-2 font-medium ${s.settingTitle} text-gray-900 `}
        >
        ...
        {isShowMore && (
          <>
            ...
            <input
              className={`w-full mt-2 rounded-lg h-10 box-border px-3 ${s.projectName} bg-gray-100`}
              ...
              <Trans
                ...
                components={{
                  privacyPolicyLink: (
                    <Link
                      href={
                        "https://docs.dream.ai/user-agreement/privacy-policy"
                      }
                      target="_blank"
        ...
        <div className="mt-10 flex justify-end">
          <Button className="mr-2 flex-shrink-0 !text-sm" onClick={onHide}>
