  ...
  return (
    <div
      className={cn(
        ...
        "mb-6 relative  rounded-2xl shadow-md border  p-8 ",
      )}
    >
      <div
        className={cn(
          "text-[24px] text-gray-800 font-semibold",
          isCloud ? "flex items-center h-8 space-x-1" : "leading-8 mb-6",
        )}
      >
        {isCloud && <em-emoji id={"😀"} />}
        {isCloud ? (
      ...
      {!isCloud && (
        <a
          ...
          href="https://cloud.dream.ai/apps"
          target="_blank"
