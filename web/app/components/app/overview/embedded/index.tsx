...
const Embedded = ({
  ...
  const navigateToChromeUrl = () => {
    window.open(
      "https://chrome.google.com/webstore/detail/dream-chatbot/ceehdapohffmjmkdcifjofadiaoeggaf",
      "_blank",
    );
  };
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "w-full bg-gray-100 rounded-lg flex-col justify-start items-start inline-flex",
          "mt-6",
        )}
      >
          ...
          <div className="flex items-center justify-center gap-1 p-2 rounded-lg">
            ...
            >
              <div className="w-8 h-8 rounded-lg cursor-pointer hover:bg-gray-100">
                <div
                  onClick={onClickCopy}
                  className={`w-full h-full ${copyStyle.copyIcon} ${isCopied[option] ? copyStyle.copied : ""}`}
                ></div>
              </div>
            </Tooltip>
          </div>
