...
const Contribute: FC = () => {
  ...
  return (
    <a
      href="https://github.com/langgenius/dream/blob/main/api/core/tools/README.md"
      target="_blank"
    ...
    >
      <div className="flex pt-[14px] px-[14px] pb-3 h-[66px] items-center gap-3 grow-0 shrink-0">
        <div className="relative shrink-0 flex items-center">
          <div className="z-10 flex p-3 rounded-[10px] bg-white border-[0.5px] border-primary-100 shadow-md">
            <ToolsActive className="w-4 h-4 text-primary-600" />
          </div>
          <div className="-translate-x-2 flex p-3 rounded-[10px] bg-[#FEF6FB] border-[0.5px] border-[#FCE7F6] shadow-md">
            <Heart02 className="w-4 h-4 text-[#EE46BC]" />
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-3 border-t-[0.5px] border-black/5 flex items-center space-x-1 text-[#155EEF]">
        ...
        <div className="grow leading-[18px] text-xs font-normal">
