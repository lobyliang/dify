  ...
  const defaultLanguage = useCallback(
    () =>
      (window.navigator.language.startsWith("zh")
        ...
        : LanguagesSupported[0]) || LanguagesSupported[0],
    [],
  );
        ...
        <div className="flex flex-col md:w-[400px]">
          ...
          <div className="w-full mx-auto mt-6">
            <Button type="primary" className="w-full !fone-medium !text-sm">
              <a href="https://dream.ai">{t("login.explore")}</a>
            </Button>
          </div>
        </div>
      )}
            ...
            <div className="bg-white">
              ...
              <div className="block w-hull mt-2 text-xs text-gray-600">
                ...
                <Link
                  ...
                  href={`https://docs.dream.ai/${language !== LanguagesSupported[1] ? "user-agreement" : `v/${locale.toLowerCase()}/policies`}/open-source`}
                >
