const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Dream account',
    langGeniusAccountTip: 'Your Dream account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Dream to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Dream allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Dream\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Dream {{version}} is now available.',
    latestAvailable: 'Dream {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
