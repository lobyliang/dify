const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Compte Dream',
    langGeniusAccountTip: 'Votre compte Dream et les données utilisateur associées.',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation envoyée, et ils peuvent se connecter à Dream pour accéder aux données de votre équipe.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Le service d\'hébergement OpenAI fourni par Dream vous permet d\'utiliser des modèles tels que GPT-3.5. Avant que votre quota d\'essai ne soit épuisé, vous devez configurer d\'autres fournisseurs de modèles.',
  ...
  apiBasedExtension: {
    title: 'Les extensions API fournissent une gestion centralisée des API, simplifiant la configuration pour une utilisation facile à travers les applications de Dream.',
    link: 'Apprenez comment développer votre propre Extension API.',
    linkUrl: 'https://docs.dream.ai/fonctionnalites/extension/extension_basee_sur_api',
  ...
  about: {
    ...
    nowAvailable: 'Dream {{version}} est maintenant disponible.',
    latestAvailable: 'Dream {{version}} est la dernière version disponible.',
  },
  appMenus: {
    overview: 'Aperçu',
