const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto Dream',
    langGeniusAccountTip: 'Twoje konto Dream i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do Dream, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez Dream pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach Dream.',
  ...
  about: {
    ...
    nowAvailable: 'Dream {{version}} jest teraz dostępny.',
    latestAvailable: 'Dream {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
    overview: 'Przegląd',
