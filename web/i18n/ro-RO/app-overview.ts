const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a Dream cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a Dream.',
        },
      },
      embedded: {
        entry: 'Încorporat',
        ...
        chromePlugin: 'Instalați extensia Chrome Dream Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'Dream-WebClient',
