...
class Config:
    ...
    def __init__(self):
        ...
        # 默认模型配置
        # 用于静默创建租户时使用
        self.DEFAULT_LLM_MODEL=get_env('DEFAULT_LLM_MODEL')
        self.DEFAULT_LLM_MODEL_PROVIDER= get_env('DEFAULT_LLM_MODEL_PROVIDER')
        self.DEFAULT_LLM_MODEL_CREDENTIALS=get_env('DEFAULT_LLM_MODEL_CREDENTIALS')

        self.DEFAULT_EMBEDDING_MODEL = get_env('DEFAULT_EMBEDDING_MODEL')
        self.DEFAULT_EMBEDDING_MODEL_PROVIDER=get_env('DEFAULT_EMBEDDING_MODEL_PROVIDER')
        self.DEFAULT_EMBEDDING_MODEL_CREDENTIALS=get_env('DEFAULT_EMBEDDING_MODEL_CREDENTIALS')

        self.DEFAULT_RERANKING_MODEL=get_env('DEFAULT_RERANKING_MODEL')
        self.DEFAULT_RERANKING_MODEL_PROVIDER=get_env('DEFAULT_RERANKING_MODEL_PROVIDER')
        self.DEFAULT_RERANKING_MODEL_CREDENTIALS=get_env('DEFAULT_RERANKING_MODEL_CREDENTIALS')
        self.DEFAULT_DERAM_CLOUD_EMAIL_DOMAIN=get_env('DEFAULT_DERAM_CLOUD_EMAIL_DOMAIN')
