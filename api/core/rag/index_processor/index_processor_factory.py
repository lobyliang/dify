...
from core.rag.index_processor.processor.row_qa_index_processor import ROW_QAIndexProcessor
...
class IndexProcessorFactory:
    ...
    def init_index_processor(self) -> BaseIndexProcessor:
        ...
        elif self._index_type == IndexType.ROW_QA_INDEX.value:
            return ROW_QAIndexProcessor()
        else:
