...
from controllers.service_api.wraps import DatasetApiResource, validate_app_token
from models.model import App, AppMode
from services.app_service import AppService
from extensions.ext_database import db

class DcAppParameterApi(DatasetApiResource):
    ...
    def get(self,tenant_id:str,app_id):
        app_model: App= db.session.query(App).filter(
                App.id == app_id,
...
api.add_resource(DcAppParameterApi, '/dreamai/parameters/<uuid:app_id>')
