...
class ChunkAttachFileApi(DatasetApiResource):
    ...
    def delete(self,tenant_id, doc_seg_id: str):
        ...
        args = parser.parse_args()
        return FileInfoService.delete_attach_file_by_id(args['file_id'])
    ...
    def post(self, tenant_id,doc_seg_id:uuid):
        ...
        try:
            ...
            docSegAttachFile = FileInfoService.bind_attach_to_chunck(args['file_id'],args['url'],args['user'],doc_seg_id,args['isCover'])
