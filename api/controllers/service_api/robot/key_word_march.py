...
DocKeyWordsFields = {fields.List(fields.Nested(DocKeyWordFields), attribute="items")}
...
class GetKeyWordsApi(DatasetApiResource):
    def get(self, tenant_id, ancestor_id: str):
        ...
        return {
            "depth": depth,
            "parent": marshal(parent, DocKeyWordFields),
            "keywords": marshal(key_words, DocKeyWordFields),
        }, 200
    ...
    def post(self, tenant_id, ancestor_id: str):
        try:
            ...
            parser.add_argument(
                ...
                location="json",
                required=False,
                help="score_threshold is required",
            )
            parser.add_argument(
                "top_n",
                type=int,
            ...
            ret2 = KeyWordService.MarhAllKeyWords(
                paragraphs,
                tenant_id,
                current_user.id,
                ancestor_id,
